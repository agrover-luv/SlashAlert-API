...
namespace SlashAlert.Api.Controllers
{
    ...
    public class PriceCacheController : BaseApiController
    {
        ...
        {
            var priceCaches = await _priceCacheRepository.GetAllAsync(RequiredUserEmail);
        ...
        {
            var priceCache = await _priceCacheRepository.GetByIdAsync(id, RequiredUserEmail);
        ...
        {
            var priceCache = await _priceCacheRepository.GetByUrlAsync(url, RequiredUserEmail);
            return priceCache != null ? Ok(priceCache) : NotFound();
        }
        ...
        {
            var priceCaches = await _priceCacheRepository.GetByProductNameAsync(productName, RequiredUserEmail);
            return Ok(priceCaches);
        }
        ...
        {
            var priceCaches = await _priceCacheRepository.GetRecentlyCheckedAsync(RequiredUserEmail, hours);
            return Ok(priceCaches);
        }
        ...
        {
            var priceCaches = await _priceCacheRepository.GetDiscountedItemsAsync(RequiredUserEmail);
            return Ok(priceCaches);
        }
    }
}
